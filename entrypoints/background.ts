      ...
      switch (message.type) {
        case "generateGeminiResponse": {
          ...
          try {
            ...
            // const text = await generateFormResponse(geminiMessage.prompt); // Temporarily commented out
            const text = "This is a test response from the background script."; // Hardcoded test response
