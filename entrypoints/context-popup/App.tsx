...
export default function App() {
  ...
  return (
    <div className="min-w-[300px] min-h-[500px] bg-gradient-to-br from-[#151625] to-[#0A0B12] shadow-2xl p-6 text-gray-100 overflow-y-auto font-sans">
      <div className="flex flex-col h-full space-y-8">
        <div
          className={`space-y-4 flex-none ${!inputInfo ? "opacity-60" : ""}`}
        >
          <h2 className="text-lg font-bold text-transparent bg-gradient-to-r from-[#7c3aed] to-[#a78bfa] bg-clip-text">
            Input Assistant
          </h2>
          <form onSubmit={handleInputSubmit} className="flex flex-col gap-4">
            <input
              ...
              className="w-full p-3 bg-[#1E1F2E] border border-[#2E2F3E] rounded-md focus:outline-none focus:ring-2 focus:ring-[#a78bfa] focus:border-transparent placeholder-gray-500 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              autoFocus={!!inputInfo}
            ...
            <button
              ...
              className={`w-full p-3 bg-gradient-to-r from-[#7c3aed] to-[#a78bfa] text-white font-semibold rounded-md
                          hover:opacity-95 focus:outline-none focus:ring-2
                          focus:ring-[#a78bfa] focus:ring-offset-2 focus:ring-offset-[#151625]
        ...
        <div className="mt-2 space-y-4">
          <h2 className="text-base font-bold text-transparent bg-gradient-to-r from-[#7c3aed] to-[#a78bfa] bg-clip-text">
            Scrape Assistant
          </h2>
          <div className="flex flex-col gap-4">
            <input
              ...
              className="w-full p-3 bg-[#1E1F2E] border border-[#2E2F3E] rounded-md focus:outline-none focus:ring-2 focus:ring-[#a78bfa] focus:border-transparent placeholder-gray-500 transition-colors duration-200"
            />
